...
- **Security SLA**: We do not provide a security SLA for community
  users. Users are encouraged to review the code and report any
...
report it through
[GitHub Security Advisories](https://github.com/kurone-kito/dantalion-web-demo/security/advisories/new)
...
[open an issue](https://github.com/kurone-kito/dantalion-web-demo/issues)
that only states a security report is pending and asks a maintainer to
reach out.

Your contributions to improving the security of this project are
appreciated.
