...
The numeric `<!-- dantalion-web-demo-autopilot-suitability: N -->`
...
`<!-- dantalion-web-demo-autopilot-suitability: N -->` authoring
convention:

```markdown
<!-- dantalion-web-demo-triage-verdict: <outcome> -->
```
...
`dantalion-web-demo-triage-verdict` marker. Apply the same
